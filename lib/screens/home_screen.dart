...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tiers = [
      ('easy', 'First Draft', '5×5'),
      ('medium', 'Fair Copy', '6×6'),
      ('hard', 'Final Ink', '7×7'),
    ];
    return Scaffold(
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.timeline, color: Palette.gold, size: 28),
                  ),
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.route, color: accent, size: 24),
                ),
                const SizedBox(width: 14),
                Expanded(
                  child: Column(
